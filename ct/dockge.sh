...
ADDON_SCRIPT="https://raw.githubusercontent.com/remz1337/ProxmoxVE/remz/tools/addon/dockge.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/remz1337/ProxmoxVE/remz/tools/addon/dockge.sh)"
MIGRATION_EOF
