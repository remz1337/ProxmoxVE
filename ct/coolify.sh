...
ADDON_SCRIPT="https://raw.githubusercontent.com/remz1337/ProxmoxVE/remz/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/remz1337/ProxmoxVE/remz/tools/addon/coolify.sh)"
MIGRATION_EOF
